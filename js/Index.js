...
$(function () {
    ...
    //产品
    $(".productsmor").attr("href", $(".products0").attr("href"));
    $('.proRight .topmenu ul li').mouseover(function () {
        var url = $(this).find("a").attr("href");
        $(".productsmor").attr("href", url);
        $('.proRight .topmenu ul li').removeClass("cur");
        $(this).addClass("cur");
        $(".proRight .proBox").eq($('.proRight .topmenu ul li').index(this)).show().siblings(".proBox").hide();
    });
    //生产车间
    jQuery("#bzBox").slide({ mainCell: ".bd ul", autoPlay: true, effect: "leftMarquee", vis: 4, interTime: 50, trigger: "click" });
    //客户见证
    jQuery(".kbList").slide({ mainCell: ".bd", autoPlay: true, effect: "topMarquee", vis: 2, interTime: 50, trigger: "click" });
    //贝壳粉涂料优势
    jQuery("#ysList").slide({ mainCell: ".ysList .bd ul", titCell: ".hd .btn span", effect: "leftLoop", autoPlay: true, delayTime: 200 });
    //产品对比
    jQuery("#pkContent").slide({ mainCell: ".bd ul", titCell: ".hd ul li", effect: "leftLoop", autoPlay: true, delayTime: 200 });
    //口碑优势
    jQuery(".kbBanner").slide({ mainCell: ".bd ul", titCell: ".hd .btn span", effect: "leftLoop", autoPlay: true, delayTime: 200 });
    //旗下品牌
    jQuery("#honerMain").slide({ titCell: ".hd ul", mainCell: ".bd ul", autoPage: true, effect: "leftLoop", autoPlay: true, vis: 1 });
    //荣誉资质
    jQuery("#honer-main").slide({ titCell: ".hd ul", mainCell: ".bd ul", autoPage: true, effect: "leftLoop", autoPlay: true, vis: 4 });
    //新闻
    $(".newsmor").attr("href", $(".news0").attr("href"));
    $('.newslist .title ul li').mouseover(function () {
        var url = $(this).find("a").attr("href");
        $(".newsmor").attr("href", url);
        $('.newslist .title ul li').removeClass("cur");
        $(this).addClass("cur");
        $(".newslist .newsBox").eq($('.newslist .title ul li').index(this)).show().siblings(".newsBox").hide();
    });
    //常见问答
...
function initCommonHeaderKeywords(_s) {
    ...
    $.post("/ajax.ashx?action=initcommonheaderkeywords&t=" + Math.random(), {
        ...
        $j("commonHeaderkeywords").html("<b>热门关键词：</b>" + msg + "");
    });
}
