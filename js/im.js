document.write("<style type='text/css'>"
    ...
    + ".ImTable{border-collapse:collapse;border:9px solid #65b21d;background:#fff}"
...
function writeIm(textS, siteNm, topOffset) {
    ...
    var rowStr = "<div style='position:fixed;_position:absolute;right:0px;width:140px;top:45%;z-index:999999;' id='divOranIm'><div id='kefubtn' style='text-align:right;cursor:pointer;display:none' ><img alt='打开客服菜单' src='/images/kf-1.png' onclick='__oran_kf_setKf(1,true)'></div><div id='bodd'><div class='ImHeader' title='隐藏客服菜单'><a href='javascript:;' onclick='__oran_kf_setKf(0,true)' class='kehu1'></a></div>";
    //rowStr = rowStr + "<div title=\"去此处咨询\" style=\"cursor: pointer;\"  class=\"Imliuyan\"><a href='/Help/Leaveword.aspx'><img src='images/liuy.png' /></a></div>";
    ...
    for (var i = 0; i < textCrumbs.length; ++i) {
        ...
        if (classIm[0]) {
            //  rowStr += "<tr><td align='center' valign='middle' height='30'><img src='images/tit.png'></td></tr>";
        }
        ...
        for (var j = 0; j < idCrumbs.length; ++j) {
            ...
            switch (imName) {
                ...
                case "ww": altText = "Wangwang"; imgPath = "images/ww.gif"; break;
            }
...
function __oran_kf_getCookie(name) {
    ...
    $(function () {
        var a = location.href;
        var b = 0;
        var c = $(".headerNav ul li").length;
        $(".headerNav ul li").each(function (e) {
