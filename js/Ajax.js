...
function $confirm(sMsg, yesObj, noObj) {
    ...
    if (jMesbook1.length == 0) {
        var sHtml = "<div id='mesbook1_c'>"
				+ "<div><img onclick='hideMsg()' id='mesbook1_cImgClose' src='images/ico9_close.gif' alt='关闭' class='fr p vam' /><span id='mesbook1_cTitle'></span></div>"
				+ "<dl class='b1'>"
					+ "<dt><img id='mesbook1_cIcon' src='images/message_ico_03.gif' alt='' title=''  /></dt>"
    ...
    //图标
    var iconPath = SKIN_PATH + "images/ico_ques.gif";
...
function $a(sMsg, boxType, autoClose, focusElmId, sTitle, behavior) {
    ...
    switch (boxType) {
        case 1: iconPath += "images/ico_ok.gif"; break;
        case 2: iconPath += "images/ico_info.gif"; break;
        case 3: iconPath += "images/ioc_ques.gif"; break;
        case -1: iconPath += "images/ico_error.gif"; break;
        default: iconPath += "images/ico_normal.gif"; break;
    }
    jMesbook1Icon.attr("src", iconPath);
...
function showProc(src, show) {
    ...
    if (show) {
        ...
        $("<img src='images/processing.gif' id='imgProc' alt='正在处理' />").insertAfter(src);
    } else {
        $(src).show();
        oImg.remove();
    }
...
//        + "<h1>付款</h1>"
//        + "<table id=\"DIR_PAY_tab\" style=\"background:url(images/Pay_ico.gif) no-repeat right top;width:400px;\">"
//        + "<tr>"
//        + "<tr>"
//        + "<th>* 付款方式：</th>"
...
function toggleJobDetail(src, _skinPath) {
    ...
    if (detail.is(":visible")) {
        detail.slideUp(80);
        jH.css({ "background": "url(images/ico14.gif) no-repeat 0 5px" });
    } else {
        detail.slideDown(80);
        jH.css({ "background": "url(images/ico13.gif) no-repeat 0 5px" });
    }
}
/********************
* 显示所有产品分类
...
function showBgProc(show, msg) {
    ...
    var oImg = $j(sElmId);
    if (oImg.length == 0) {
        $(document.body).append("<div id='" + sElmId + "'><p><img src='images/processing_2.gif' id='imgProc' alt='" + msg + "' /></p>"
...
function copyUrl(_mark) {
    ...
    if (jLayer.length == 0) {
        var sHtml = "<div id='div_nsw_copy_url'>"
                + "<h1><a href='javascript:void(0)' onclick=\"$(this).parent().parent().fadeOut(80);hideFullBg('div_nsw_copy_url_bg')\"><img src='images/ico9_close.gif' /></a>拷贝链接地址</h1>"
                + "<div class='cont'>"
...
function contractExtend(src, skinPath) {
    ...
    if (jSrc.attr("alt") == "收缩") {
        alt = "展开";
        icon = "images/ico15_.gif";
        jDiv.slideUp(80);
    } else {
        alt = "收缩";
        icon = "images/ico15.gif";
        jDiv.slideDown(80);
    }
...
function contractExtendProdColumn(src, _skin) {
    ...
    if (jSrc.attr("alt") == "收缩") {
        alt = "展开";
        icon = "images/ico14.gif";
        jDiv.slideUp(80);
    } else {
        alt = "收缩";
        icon = "images/ico13.gif";
        jDiv.slideDown(80);
    }
